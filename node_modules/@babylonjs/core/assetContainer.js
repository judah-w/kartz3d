...
var AssetContainer = /** @class */ (function (_super) {
    ...
    AssetContainer.prototype.instantiateModelsToScene = function (nameFunction, cloneMaterials, options) {
        ...
        var localOptions = __assign({ doNotInstantiate: true }, options);
        if (!localOptions.doNotInstantiate) {
            // Always clone skinned meshes.
            localOptions.doNotInstantiate = function (node) { return !!node.skeleton; };
        }
        ...
        this.transformNodes.forEach(function (o) {
            ...
            if (!o.parent) {
                var newOne = o.instantiateHierarchy(null, localOptions, function (source, clone) {
