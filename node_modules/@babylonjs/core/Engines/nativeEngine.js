...
var NativeEngine = /** @class */ (function (_super) {
    ...
    NativeEngine.prototype._readTexturePixels = function (texture, width, height, faceIndex, level, buffer, flushRenderer, noDataConversion, x, y) {
        var _a, _b, _c, _d;
        if (faceIndex !== undefined && faceIndex !== -1) {
            throw new Error("Reading cubemap faces is not supported, but faceIndex is ".concat(faceIndex, "."));
        }
        return this._engine
